      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Acesse sua conta e gerencie seus clientes, produtos e agenda de forma simples e eficiente.
          </p>
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg">Controle total do negócio</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="h-12 w-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center backdrop-blur-sm">
                <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-lg">Segurança garantida</span>
            </div>
          </div>
        </div>
      </div>
